...
const Footer: React.FC = () => {
  return (
    <footer id="contact" className="bg-restaurant-dark-gray text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="font-playfair text-2xl font-bold mb-4">Taberna do Gute</h3>
            <p className="mb-6 opacity-80">
              Uma experiência única com o melhor da culinária alemã e brasileira em um ambiente acolhedor.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="bg-restaurant-dark-teal p-2 rounded-full hover:bg-restaurant-medium-green transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                </svg>
              </a>
              <a href="https://instagram.com" className="bg-restaurant-dark-teal p-2 rounded-full hover:bg-restaurant-medium-green transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            <h4 className="font-playfair text-xl font-bold mb-4">Informações</h4>
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <MapPin className="h-5 w-5 text-restaurant-medium-green shrink-0 mt-0.5" />
                <span>Av. Presidente Castelo Branco, 3498 - Horizonte, CE, 62880-000</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-restaurant-medium-green shrink-0" />
                <span>(85) 99999-9999</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-restaurant-medium-green shrink-0" />
                <span>contato@tabernadogute.com.br</span>
              </li>
              <li className="flex items-start space-x-3">
                <Clock className="h-5 w-5 text-restaurant-medium-green shrink-0 mt-0.5" />
                <div>
          ...
          <div>
            <h4 className="font-playfair text-xl font-bold mb-4">Mapa</h4>
        ...
        <div className="mt-12 pt-8 border-t border-restaurant-medium-green/30">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="mt-4 sm:mt-0">
              <ul className="flex space-x-6 text-sm opacity-70">
                <li>
                  <Link to="/" className="hover:text-restaurant-medium-green transition-colors">
